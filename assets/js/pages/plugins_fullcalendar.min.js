$(function() {
    ...
    calendar_selectable: function() {
        ...
        t.length && t.fullCalendar({
            ...
            selectHelper: !0,
            select: function(a, r) {
                UIkit.modal.prompt('<h3 class="heading_b uk-margin-medium-bottom">Novo Evento</h3>\n\
                                    <div class="uk-margin-medium-bottom" id="calendar_colors">Cor:' + e + "</div>Título:", "", function(e) {
                    if ("" !== $.trim(e)) {
